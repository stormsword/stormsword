...
export class Select extends Phaser.State {
  ...
  create() {
    ...
    // Warrior
    this.warrior = new Character('warriorSelect', this.game, this.game.world.centerX-145, 200, 'warrior')
  ...
  onMouseOver(sprite) {
    ...
    let tween = this.game.add.tween(this.selector).to( { alpha: 1 }, 250, Phaser.Easing.Exponential.None, true, 0, -1);
    tween.yoyo(true, 300);

...
export class Spritesheet extends Phaser.State {
  ...
  loadSprite(name) {
    ...
    this.character.events.onLoad.add(() => {
      this.anims = this.character.data

      for(let anim in this.anims) {
        console.log(this.anims[anim])
      }

    })
    // console.log(this.character.events)
    // console.log(this.character.anims)

    // for(let key in animations) {
    //   // console.log(animations[key])
    //   let name = animations[key].name
    //   // let
    //
    // }
    // if(animations) {
    ...
    // if(this.character.sprite._anims) {
    //   console.log('ot here')
    //   console.log(this.character.sprite._anims)
    // }
  }

...
export class LevelEditor extends Phaser.State {
  ...
  create() {
    ...
    this.currentLayer = this.map.create('level1', 40, 30, 16, 16);

    this.createTileSelector(); // Create our tile selector
  ...
  createTileSelector() {
    ...
    var tileStrip = tileSelector.create(1, 1, 'grass_corners');
